...
def smart():
    fileName = "D:\Iot_Project\Smart-plug-OTA\smart-plug-v6\cmake-build-debug\src\Smart_Plug_Project.bin"
...
def plug():
    fileName = "../blu/cmake-build-debug/src/blu.bin"
    if not os.path.isfile(fileName):
        abort(404)
...
def grn():
    #fileName = "../grn/cmake-build-debug/src/grn.bin"
    fileName="D:\Iot_Project\smart-plug-v4\cmake-build-debug\src\Smart_Plug_Project.bin"
    if not os.path.isfile(fileName):
        print("File not found", os.path.abspath(fileName))
        abort(404)
